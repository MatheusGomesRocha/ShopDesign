/**
    TELA PARA PREENCHER O FORM COM EMAIL CADASTRADO PARA REALIZAR A RECUPERAÇÃO DE SENHA ESQUECIDA (ACESSADO PELA LINK
    FORGOTTEN PASSWORD EM "ACCOUNT SETTINGS" E NA TELA AFFILIATE
 */
